...
const Footer: React.FC = () => {
  ...
  return (
    <footer ref={footerRef} className="relative z-20 px-4 md:px-8 pb-8 -mt-12 footer-fade-in bg-transparent">
      <div className="max-w-7xl mx-auto bg-gradient-to-b from-gray-950 via-gray-900 to-gray-950 text-white rounded-[2.5rem] overflow-hidden shadow-2xl relative">
        ...
        <div className="absolute bottom-0 right-1/4 w-80 h-80 bg-purple-600/20 rounded-full blur-3xl animate-float-slower"></div>
        ...
        <div className="px-6 py-12 md:p-16 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            ...
            <div className="space-y-6 footer-column">
              <div className="flex items-center gap-2 group">
                ...
                <h3 className="text-2xl font-bold bg-gradient-to-r from-indigo-400 via-purple-400 to-pink-400 bg-clip-text text-transparent animate-gradient-x">
                  RESQ360
                </h3>
              </div>
          ...
          <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4 text-sm relative">
            ...
            <p className="text-gray-400 flex items-center gap-2 hover:text-white transition-colors duration-300">
              Made with <span className="text-red-500 animate-heartbeat inline-block">❤️</span> in India
            </p>
          </div>
        </div>
